...
6. For using multiple node versions in your system , You can use nvm if you want to manage multiple Node versions on your computer and use multiple node versions.
